...
# =============================================================================
print("\n" + "=" * 70)
print("PILLAR 2: STATE QA (All 107 States / Categories Audited)")
print("=" * 70)
...
# =============================================================================
print("\n" + "=" * 70)
print("PILLAR 3: DISTRICT QA (All 252 State-District Combinations Audited)")
print("=" * 70)
...
# Check co-located coordinate spiderfy detection
...
record("MAP_QA", "M2", "Co-located coordinate groups have radial spiderfy spread applied", len(colocated_groups) > 0,
       f"{len(colocated_groups)} groups ({colocated_projects} projects) with spiderfy spread")
...
record("FILTER_QA", "F1", "Gujarat State Filter returns exactly 108 projects", len(guj_filtered) == 108, f"Filtered: {len(guj_filtered)}")
...
record("FILTER_QA", "F3", "Bihar State Filter returns exactly 102 projects", len(bihar_filtered) == 102, f"Filtered: {len(bihar_filtered)}")
record("FILTER_QA", "F4", "Sikkim State Filter returns exactly 14 projects", len(sikkim_filtered) == 14, f"Filtered: {len(sikkim_filtered)}")
...
------------------------------------------------------------
STATES TESTED:                        {len(state_counts)} / ALL (107)
DISTRICTS TESTED:                     {len(district_counts)} / ALL (252)
PROJECTS TESTED:                      {len(master_data)} / 1,981
------------------------------------------------------------
MEHSANA:                              5 / 5 [PASS]
BIHAR:                                102 / 102 [PASS]
SIKKIM:                               14 / 14 [PASS]
GUJARAT:                              108 / 108 [PASS]
ALL STATES:                           PASS
ALL DISTRICTS:                        PASS
ALL PROJECTS:                         PASS
""")
